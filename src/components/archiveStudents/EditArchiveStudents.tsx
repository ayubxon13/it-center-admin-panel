...
// async function editArchiveStudent(data: IArchiveStudents) {
//   try {
//     const res = await customFetch.put(`archive-students/${data._id}`, data);
...
// function EditArchiveStudents({isOpen}: {isOpen: boolean}) {
...
//   );
// }
// export default EditArchiveStudents;
